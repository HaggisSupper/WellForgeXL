...
This is the local, multi-file browser UI for inspecting the shared WellForge engine exchange case. It has tabbed views for overview, trajectory, BHA geometry, hydraulics, torque & drag, and raw exchange data.
